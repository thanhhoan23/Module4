...
<div id="wrapper">
        ...
        <ul class="list-unstyled topnav-menu float-right mb-0">
            ...
            <li class="dropdown notification-list">
                ...
                <div class="dropdown-menu dropdown-menu-right dropdown-lg" style="">
                    ...
                    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 543.258px;"><div class="slimscroll noti-scroll" style="overflow: hidden; width: auto; height: 543.258px;">
    ...
    <div class="left-side-menu">
        ...
        <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 317px;"><div class="slimscroll-menu" style="overflow: hidden; width: auto; height: 317px;">
                ...
                <ul class="metismenu mm-show" id="side-menu">
                    ...
                    <li class="mm-active">
                        ...
                        <ul class="nav-second-level mm-collapse mm-show" aria-expanded="false">
                            <li class="mm-active">
                                <a href="tables-basic.html" class="active">Basic Tables</a>
                            </li>
                            <li>
        ...
        </div><div class="slimScrollBar" style="background: rgb(158, 165, 171); width: 8px; position: absolute; top: -357.586px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 125.142px;"></div><div class="slimScrollRail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div>
        <!-- Sidebar -left -->
...
<div class="right-bar">
    ...
    <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 377px;"><div class="slimscroll-menu" style="overflow: hidden; width: auto; height: 377px;">
        <hr class="mt-0">
    ...
    </div><div class="slimScrollBar" style="background: rgb(158, 165, 171); width: 8px; position: absolute; top: -419px; opacity: 0.4; display: none; border-radius: 7px; z-index: 99; right: 1px; height: 182.685px;"></div><div class="slimScrollRail" style="width: 8px; height: 100%; position: absolute; top: 0px; display: none; border-radius: 7px; background: rgb(51, 51, 51); opacity: 0.2; z-index: 90; right: 1px;"></div></div> <!-- end slimscroll-menu-->
</div>
<!-- /Right-bar -->
